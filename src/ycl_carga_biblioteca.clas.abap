class ycl_carga_biblioteca definition
  public
  final
  create public .
...
class ycl_carga_biblioteca implementation.

  method if_oo_adt_classrun~main.

    data: lt_acc_categ type table of yacc_categ_log,
          lt_catego    type table of ycateg_log,
          lt_clientes  type table of ycliente_log,
          lt_clnts_lib type table of yclnts_lib_log,
          lt_libros    type table of ylibros_log.
...
******** yacc_categ_log ********
    ...
    delete from yacc_categ_log.
    insert yacc_categ_log from table @lt_acc_categ.
...
******** ycateg_log ********
    ...
    "Delete possible entries; insert new entries
    delete from ycateg_log.
    insert ycateg_log from table @lt_catego.
...
******** ycliente_log ********
    ...
    "Delete possible entries; insert new entries
    delete from ycliente_log.
    insert ycliente_log from table @lt_clientes.
...
******** yclnts_lib_log
    ...
    "Delete possible entries; insert new entries
    delete from yclnts_lib_log.
    insert yclnts_lib_log from table @lt_clnts_lib.
...
******** ylibros_log ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    delete from ylibros_log.
    insert ylibros_log from table @lt_libros.
